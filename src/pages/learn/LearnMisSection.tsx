    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-start gap-3 bg-sky-500/10 border border-sky-500/40 rounded-sm px-4 py-3.5">
        ...
        <p className="text-sm text-sky-200 leading-relaxed">
          Чтобы улучшить проверку твоего отчета и получить одобрение, сортируй все свои доказательства по папкам. Например: лечения в одну папку с лечениями, строи в папку со строями, чтобы каждый строй был в отдельных папках. Пока что учись и повышайся, всему остальному мы тебя научим ❤️
        </p>
      </div>
