  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        {/* !онлайн */}
        <div className="flex items-center gap-3 bg-green-950/30 border border-green-700/50 rounded-sm px-4 py-3">
          <Icon name="LogIn" size={16} className="text-green-400 shrink-0" />
