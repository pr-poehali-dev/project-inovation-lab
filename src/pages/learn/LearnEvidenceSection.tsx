        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-start gap-3 bg-sky-500/10 border border-sky-500/40 rounded-sm px-4 py-3">
            ...
            <p className="text-sm text-sky-300 leading-relaxed">
              <span className="font-bold">Совет:</span> обрати внимание на то, как на Скриншоте №1 выглядит чат. Он выглядит расширенным и туда помещаются и твои действия, и действия твоих коллег, что увенчивается успехом при одобрении отчета. Также, будь внимательнее и всегда надевай медицинскую сумку, чтобы тебе не выдали наказание.
            </p>
          </div>
        </div>
